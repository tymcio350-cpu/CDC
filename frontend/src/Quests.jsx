...
// backgroundFile              // optional path to a background image (e.g. "/dinos/quests_bg.png")
export default function Quests({
  ...
  return (
    <div className="q-root" aria-live="polite">
      {/* background layer - uses provided image or falls back to a subtle gradient */}
      <div
        className="q-bg"
        aria-hidden
        style={backgroundFile ? { backgroundImage: `url(${backgroundFile})` } : undefined}
      />
        ...
        <div className="q-main">
          ...
          <section className="q-section">
            ...
            <div className="q-card q-social">
              ...
              <div className="q-small-muted" style={{ marginTop: 8 }}></div>
            </div>
          </section>
        </div>

        <footer className="q-footer"></footer>
      </div>
    </div>
  );
}
